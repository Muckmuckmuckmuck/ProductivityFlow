#!/usr/bin/env python3
"""
ProductivityFlow Backend - Final Working Version
Simplest possible backend that works with any database
"""
...
# Use existing database URL or fallback to SQLite
...
# Ultra-simple models - only essential fields
class Team(db.Model):
    __tablename__ = 'teams'
